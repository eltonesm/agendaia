package com.simboraagendar.organization;
...
import com.simboraagendar.organization.adapter.in.web.request.RegistrationRequest;
...
class SlugUnavailableIT {
    ...
    @Autowired private com.simboraagendar.organization.application.port.out.ProfessionalRepository professionalRepository;
    @Autowired private com.simboraagendar.organization.application.port.out.BusinessOperatingHoursRepository businessOperatingHoursRepository;
    @Autowired private com.simboraagendar.organization.application.port.out.WorkScheduleRepository workScheduleRepository;
    @Autowired private com.simboraagendar.organization.application.port.out.TimeOffRepository timeOffRepository;
    ...
    void limpar() {
        ...
        // (TODO-004) — todos precisam sair primeiro.
