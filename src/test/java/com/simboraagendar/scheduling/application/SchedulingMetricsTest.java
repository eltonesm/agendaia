...
class SchedulingMetricsTest {
    ...
    void appointmentCreatedIncrementaSoCriado() {
        ...
        assertThat(valor("simboraagendar.appointments.booked")).isEqualTo(1.0);
        assertThat(valor("simboraagendar.appointments.cancelled")).isEqualTo(0.0);
        assertThat(valor("simboraagendar.appointments.slot_conflict")).isEqualTo(0.0);
    }
    ...
    void appointmentCancelledIncrementaSoCancelado() {
        ...
        assertThat(valor("simboraagendar.appointments.cancelled")).isEqualTo(1.0);
        assertThat(valor("simboraagendar.appointments.booked")).isEqualTo(0.0);
        assertThat(valor("simboraagendar.appointments.slot_conflict")).isEqualTo(0.0);
    }
    ...
    void slotConflictIncrementaSoFalhaPorConflito() {
        ...
        assertThat(valor("simboraagendar.appointments.slot_conflict")).isEqualTo(1.0);
        assertThat(valor("simboraagendar.appointments.booked")).isEqualTo(0.0);
        assertThat(valor("simboraagendar.appointments.cancelled")).isEqualTo(0.0);
    }
    ...
    void appointmentCompletedIncrementaSoConcluido() {
        ...
        assertThat(valor("simboraagendar.appointments.completed")).isEqualTo(1.0);
        assertThat(valor("simboraagendar.appointments.booked")).isEqualTo(0.0);
        assertThat(valor("simboraagendar.appointments.cancelled")).isEqualTo(0.0);
        assertThat(valor("simboraagendar.appointments.slot_conflict")).isEqualTo(0.0);
    }
    ...
    void contadoresComecamEmZeroESaoCumulativos() {
        ...
        assertThat(valor("simboraagendar.appointments.booked")).isEqualTo(2.0);
    }
}
