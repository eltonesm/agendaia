 ...
 *
 * <p>O Modulith trata cada subpacote direto de {@code com.simboraagendar} como um
...
class ModuleStructureTest {
    ...
    private static final ApplicationModules MODULOS =
            ApplicationModules.of(SimboraAgendarApplication.class);
