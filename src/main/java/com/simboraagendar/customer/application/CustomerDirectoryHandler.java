package com.simboraagendar.customer.application;
...
import com.simboraagendar.customer.application.port.out.CustomerRepository;
...
public class CustomerDirectoryHandler implements CustomerDirectory {
    ...
    public Optional<CustomerRef> find(UUID id) {
        var tenantId = TenantContext.require();
