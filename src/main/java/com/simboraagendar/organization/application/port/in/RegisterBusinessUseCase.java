...
public interface RegisterBusinessUseCase {
    ...
    /**
     * @throws com.simboraagendar.organization.domain.exception.SlugUnavailableException
     *     se o link estiver em uso ou for reservado
     * @throws com.simboraagendar.organization.domain.exception.EmailAlreadyUsedException
