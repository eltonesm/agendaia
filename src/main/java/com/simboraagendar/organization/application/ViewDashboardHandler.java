...
import com.simboraagendar.organization.application.port.in.DashboardView;
import com.simboraagendar.organization.application.port.in.ViewDashboardUseCase;
...
public class ViewDashboardHandler implements ViewDashboardUseCase {
    ...
    public ViewDashboardHandler(
            ...
            @Value("${simboraagendar.public-base-url}") String publicBaseUrl) {
        this.businessRepository = businessRepository;
        // Barra no fim é o jeito natural de escrever a variável de ambiente, e
        // produziria "https://simboraagendar.com//b/slug". O link que o dono manda
