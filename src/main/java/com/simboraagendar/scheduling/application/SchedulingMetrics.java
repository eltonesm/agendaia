...
class SchedulingMetrics {
    ...
    SchedulingMetrics(MeterRegistry registry) {
        // "simboraagendar.appointments.created" foi tentado primeiro e descartado:
        ...
        // a métrica saía como "simboraagendar_appointments_total" — sem "created"
        ...
        created = Counter.builder("simboraagendar.appointments.booked").register(registry);
        cancelled = Counter.builder("simboraagendar.appointments.cancelled").register(registry);
        slotConflict = Counter.builder("simboraagendar.appointments.slot_conflict").register(registry);
        completed = Counter.builder("simboraagendar.appointments.completed").register(registry);
    }
